...
Aero7 is an independent, open-source Linux distribution that brings the calm,
glassy desktop spirit of the late 2000s to a modern system. It combines an
**Arch Linux** foundation with **KDE Plasma 6** and a **Wayland** session,
wrapped in a cohesive turquoise, deep-blue, white, and neon-green Aero
experience from installer to desktop.
...
<table>
<tr>
<td width="25%" align="center"><strong>💿 Beta 1</strong><br>Guided Aero7 installation</td>
<td width="25%" align="center"><strong>🏹 Arch Linux</strong><br>Modern rolling foundation</td>
<td width="25%" align="center"><strong>💠 Plasma 6</strong><br>Polished KDE desktop</td>
<td width="25%" align="center"><strong>🟢 Wayland</strong><br>Modern display session</td>
</tr>
</table>
...
> the target disk carefully, and do not install it over irreplaceable data.
...
Aero7 welcomes focused bug reports, tested fixes, documentation improvements,
translations, packaging work, and verified application integrations.
...
Aero7 and the Aero7 Open Project are independent open-source projects. They are
...
of companies. All other trademarks belong to their respective owners. Aero7
recreates interface ideas and visual themes using open-source components; it
does not include a licensed copy of Microsoft Windows and does not claim to be
a Microsoft product.

Third-party packages, themes, fonts, and artwork retain their respective
licenses and notices. The license covering Aero7 source code does not
automatically grant rights to every bundled or referenced visual asset.
